...
Upstream OAuth support for registration-time authorization is now available in beta.
...
## 3. A Web GUI
We're working on a browser-based UI for easier management and visibility.

It will serve as an alternative to the mcpjungle CLI.
