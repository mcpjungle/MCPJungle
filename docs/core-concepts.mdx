...
## Mcpjungle server
The long-running HTTP service that you run either locally or deploy to a server.
...
eg-
```text
mcpj://res/my_files_mcp/ZmlsZTovL3NhbXBsZS50eHQ
```

AI clients can discover and use these URIs.
...
- you want centralized management and governance features such as observability, audit logs, etc
