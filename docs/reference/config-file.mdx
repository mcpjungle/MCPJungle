---
title: "Mcpjungle CLI configuration file"
description: "Reference for ~/.mcpjungle.conf, the YAML file the CLI reads for the registry URL and access token, plus all JSON config file formats used to register servers and create resources."
---
...
<Steps>
  <Step title="Enterprise server (admin token)">
  ...
  <Step title="User login (user token)">
