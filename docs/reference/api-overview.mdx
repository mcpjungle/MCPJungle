---
title: "Mcpjungle HTTP API overview"
description: "Base URL, authentication, access levels, and a complete map of every endpoint group and MCP proxy surface exposed by the Mcpjungle gateway server."
---
