...
func TestToolInputSchema(t *testing.T) {
	t.Run("ToolInputSchema struct creation", func(t *testing.T) {
	...
	t.Run("ToolInputSchema JSON marshaling", func(t *testing.T) {
		schema := ToolInputSchema{
			Type: "string",
		}
...
func TestTool(t *testing.T) {
	t.Run("Tool struct creation", func(t *testing.T) {
		tool := Tool{
			Name:        "test-tool",
			Enabled:     true,
	...
	t.Run("Tool JSON marshaling", func(t *testing.T) {
		tool := Tool{
			Name:        "json-tool",
			Enabled:     false,
...
func TestToolInvokeResult(t *testing.T) {
	t.Run("ToolInvokeResult struct creation", func(t *testing.T) {
	...
	t.Run("ToolInvokeResult JSON marshaling", func(t *testing.T) {
		result := ToolInvokeResult{
			Meta:    map[string]any{"status": "success"},
			IsError: false,
